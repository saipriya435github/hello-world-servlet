...
// for display purposes
      ...
      git 'https://github.com/saipriya435github/hello-world-servlet.git'
...
post {
        success {
            mail to:"saipriya16896@gmail.com", subject:"SUCCESS: ${currentBuild.fullDisplayName}", body: "Build success"
        }
        failure {
            mail to:"saipriya168960@gmail.com", subject:"FAILURE: ${currentBuild.fullDisplayName}", body: "Build failed"
        }
    }       
}
